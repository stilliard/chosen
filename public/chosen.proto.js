...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.multi_temp = new Template('<ul class="chosen-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:150px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
    ...
    Chosen.prototype.keydown_checker = function(evt) {
      ...
      switch (stroke) {
        case 8:
          ...
          break;
        case 9:
          if (this.results_showing && this.search_field.val().length && (!this.is_multiple || this.result_highlight)) {
            this.result_select(evt);
          }
          this.mouse_on_container = false;
          break;
