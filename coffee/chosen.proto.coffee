class @Chosen extends AbstractChosen
  ...
  set_default_values: ->
    ...
    @multi_temp = new Template('<ul class="chosen-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:150px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>')
  ...
  search_field_scale: ->
    if @is_multiple
      ...
      w = Element.measure(div, 'width') + 150
      div.remove()
